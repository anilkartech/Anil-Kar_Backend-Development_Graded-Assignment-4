...
public class EmployeeRestController {
	...
	@GetMapping("/sort")
	public List<Employee> fetchEmployeesSortedByFirstName(
			@RequestParam(value = "order", defaultValue = AppConstants.DEFAULT_SORT_DIRECTION, required = false) String sortDir) {
